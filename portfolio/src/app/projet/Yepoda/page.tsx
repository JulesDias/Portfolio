        ...
        <div className="absolute inset-0 flex items-end justify-between px-8 md:px-16 max-w-7xl mx-auto">
          <div className="z-10 max-w-xl pb-12">
            ...
            <p className="font-Avenir text-lg text-white mb-8 leading-relaxed">
              Création d'une typographie sur mesure pour traduire l'esprit
              coloré et contemporain de la marque Yepoda.
            </p>
            ...
            <div className="mt-6 text-left text-sm">
              <p className="font-Avenir text-white">
                ...
                Adobe Illustrator (formes vectorielles) • Glyphs (création du
                fichier) • Photoshop (mise en situation)
              </p>
            </div>
          </div>
          <motion.div
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="font-Avenir text-gray-700 space-y-4 leading-relaxed">
              <p>
                Ce projet vise à concevoir une{" "}
                <strong>typographie identitaire</strong> pour une marque à forte
                personnalité visuelle, mais sans police propre.
              </p>
              <p>
                L'objectif était de créer un alphabet capable de traduire
                l'esprit et les valeurs de la marque, tout en restant cohérent
                avec son univers graphique.
              </p>
              <p>
                Le travail a débuté par une analyse de l'identité de Yepoda, de
                son logo et de ses courbes, afin de définir les bases d'une
          ...
          <div className="bg-PinkCustom p-8 rounded-2xl">
            ...
            <div className="font-Avenir text-white space-y-3 leading-relaxed">
              <p>
                J'ai choisi <strong>Yepoda</strong> pour son univers coloré et
                contemporain, offrant une large liberté créative.
              </p>
              <p>
                La marque reflète une identité jeune, dynamique et positive,
                parfaite pour explorer la création d'une typographie expressive
                et cohérente.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-32">
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="font-Avenir text-gray-600 leading-relaxed">
                  Étude approfondie de l'identité de Yepoda, de son logo et de
                  ses courbes pour définir les bases typographiques.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="font-Avenir text-gray-600 leading-relaxed">
                  Conception des lettres capitales et minuscules, ainsi que des
                  signes de ponctuation dans Illustrator et Glyphs.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-6 items-start">
              ...
              <div>
                ...
                <p className="font-Avenir text-gray-600 leading-relaxed">
                  Test de la typographie sur différents supports pour en valider
                  la pertinence visuelle et fonctionnelle.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-5xl mx-auto px-8">
          ...
          <div className="bg-white p-12 rounded-2xl shadow-xl">
            <p className="font-Yepoda text-2xl md:text-3xl text-gray-800 leading-relaxed text-center">
              Yepoda s'inspire de la nature et du quotidien. Les formes sont
              simples, les couleurs apaisantes, les gestes sincères. Cette
              typographie reflète un univers équilibré, entre énergie et
              douceur. Elle respire, elle sourit, elle invite à prendre le
              temps. Une écriture lumineuse, pensée pour célébrer la simplicité
              et le bien-être.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white p-6 md:p-12 rounded-2xl shadow-lg">
          <div className="space-y-8">
            <div className="text-center">
              <h3 className="font-Poppins text-lg md:text-xl font-bold mb-4 text-gray-900">
                Majuscules
              </h3>
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="font-Avenir text-gray-600 leading-relaxed">
                Une typographie qui traduit fidèlement l'esprit jeune, dynamique
                et positif de Yepoda.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="font-Avenir text-gray-600 leading-relaxed">
                Des formes inspirées du logo et de l'identité visuelle existante
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="font-Avenir text-gray-600 leading-relaxed">
                Majuscules, minuscules et ponctuation créés pour une utilisation
                polyvalente sur tous supports.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="font-Avenir text-gray-600 leading-relaxed">
                Testée et validée sur divers supports : packaging, affichage,
